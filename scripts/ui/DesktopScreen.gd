...
var color_presets: Dictionary = {
	...
	"crimson": {
		"tagline_color":		Color(1.0, 0.4, 0.45, 1),
		"clock_color":		  Color(1.0, 0.5, 0.55, 1),
		"status_color":		 Color(1.0, 0.4, 0.45, 0.4),
		"background_modulate":  Color(0.214, 0.094, 0.12, 0.502),
		"mouse_glow_color":	 Color(1.0, 0.4, 0.45, 0.15),
		"particle_color":	   Color(1.0, 0.4, 0.45, 0.4),
		"border_glow_color":	Color(1.0, 0.4, 0.45, 1),
		"button_bg_glow_color": Color(1.0, 0.4, 0.45, 1),
		"app_name_color":	   Color(1.0, 0.7, 0.75, 1.0),
	},
	"emerald": {
